...
function saveThemeToStorage(theme: "light" | "dark" | "premium-dark") {
  try { if (typeof window !== "undefined") localStorage.setItem("brandflow-theme", theme); } catch {}
}
...
function saveLanguageToStorage(lang: "en" | "ur") {
  try { if (typeof window !== "undefined") localStorage.setItem("brandflow-language", lang); } catch {}
}
