...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Absolutely! BrandForge offers easy import tools for data from popular platforms like Shopify, WooCommerce, and others. Our support team is also available to help with migration to ensure a smooth transition.",
  },
  {
    question: "Is my data secure?",
    answer:
      "Enterprise-grade security is at the core of BrandForge. We use AES-256 encryption for data at rest, TLS 1.3 for data in transit, and our infrastructure is hosted on secure cloud providers with SOC 2 Type II compliance.",
  },
  {
    question: "Do you offer custom branding?",
    answer:
      "White-label branding is available on our Enterprise plan. This includes custom logos, colors, domains, and branded email templates to make BrandForge feel like your own platform.",
  },
  {
    question: "What integrations are available?",
    answer:
      "BrandForge integrates with WooCommerce, Shopify, WhatsApp Business API, Google Analytics, Stripe, and more. Enterprise customers also get access to our API for custom integrations.",
  },
];
            ...
            {faqs.map((faq, index) => (
              ...
              >
                <AccordionTrigger className="text-left text-base font-medium text-white hover:text-amber-400 py-5 hover:no-underline">
                  {faq.question.replaceAll("BrandForge", companyName)}
                </AccordionTrigger>
                <AccordionContent className="text-slate-400 leading-relaxed pb-5">
                  {faq.answer.replaceAll("BrandForge", companyName)}
                </AccordionContent>
              </AccordionItem>
            ))}
          </Accordion>
