...
export function AuthScreen() {
  const { setView, setUser, setOrganization, setBrandName, setBrandConfigured, brandConfigured, brandLogo, brandName, brandTagline } = useBrandFlowStore();
  ...
  // Use brand identity if configured, otherwise default BrandFlow
  ...
  const displayTagline = showBrandIdentity && brandTagline ? brandTagline : "The Pulse of Your Business";
