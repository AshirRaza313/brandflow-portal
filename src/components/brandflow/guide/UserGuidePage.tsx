...
const DEFAULT_GUIDE: GuideData = { tabs: [
  ...
  { id: "plans", label: "Plans & Billing", icon: "Crown", items: [
    { id: "pl1", title: "Subscription Plans Overview", content: "Three tiers are available: Starter (free, up to 50 products, 100 orders lifetime limit, 3 team members), Growth (Rs 4,999/month, 200 products, unlimited orders, 15 team members, advanced features), and Enterprise (Rs 14,999/month, everything unlimited + AI tools + custom integrations + dedicated support). Choose the plan that fits your current business size and upgrade as you grow." },
