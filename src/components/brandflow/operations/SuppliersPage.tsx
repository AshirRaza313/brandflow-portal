...
import { Building2, ShoppingCart, DollarSign, Truck } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className={isDark ? "flex flex-wrap gap-1 border-b border-slate-700/60" : "flex flex-wrap gap-1 border-b border-slate-200"}>
        ...
        <button className={isDark ? "px-4 py-2.5 text-sm font-medium border-b-2 border-transparent text-slate-400 hover:text-slate-200" : "px-4 py-2.5 text-sm font-medium border-b-2 border-transparent text-slate-500 hover:text-slate-700"}>Performance Ratings</button>
      </div>
